...
class ManagedObject:
    ...
    def object_type(self):
        """
        Accessor and property definition for the object_type attribute.

        Returns:
            None: if object_type is unset.
            ObjectType: ObjectType enumeration if set.
        """
    ...
    def object_type(self, value):
        """
        Set blocker for the object_type attribute.
